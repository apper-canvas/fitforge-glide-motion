...
import { workoutLogService, userProfileService } from '@/services';
      ...
      <Card>
        ...
        <div className="grid grid-cols-7 gap-1">
          {['S', 'M', 'T', 'W', 'T', 'F', 'S'].map(day => (
            <div key={day} className="text-xs text-surface-500 text-center p-1 font-medium">
              {day}
            </div>
          ))}
    ...
    <div className="p-4 pb-24 max-w-full overflow-hidden">
      <div className="max-w-6xl mx-auto space-y-6">
            ...
            {workoutLogs.slice(0, 10).map((log, index) => (
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <Badge
                    variant={log.completed ? 'success' : 'warning'}
                    size="sm"
                  >
        ...
        <Card>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              { name: 'First Workout', icon: 'Star', unlocked: stats.totalWorkouts >= 1 },
              { name: '7 Day Streak', icon: 'Flame', unlocked: stats.currentStreak >= 7 },
              { name: '10 Workouts', icon: 'Target', unlocked: workoutLogs.filter(l => l.completed).length >= 10 },
              { name: 'Consistency King', icon: 'Crown', unlocked: stats.currentStreak >= 30 }
              ...
              <motion.div
                ...
                className={`
                  ...
                  ${achievement.unlocked 
                    ? 'bg-gradient-to-br from-warning/20 to-accent/20 border-warning/30' 
              ...
              >
                ...
                <h4 className={`
                  ...
                  ${achievement.unlocked ? 'text-white' : 'text-surface-500'}
                `}>
                  {achievement.name}
                </h4>
