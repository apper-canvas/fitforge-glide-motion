...
secondary: "bg-surface-300 text-surface-950 hover:bg-surface-400 focus:ring-surface-500 border border-surface-400",
    success: "bg-gradient-to-r from-success to-accent text-surface-950 hover:from-success/90 hover:to-accent/90 focus:ring-success shadow-lg shadow-success/25",
    ...
    ghost: "text-surface-800 hover:text-surface-950 hover:bg-surface-200 focus:ring-surface-500",
